...
export class BulkDismissAlarmsHandler extends BaseToolHandler {
  ...
  description =
    'Dismiss multiple security alarms in a single operation. Requires array of alarm IDs. Does not permanently delete alarms.';
  category = 'security' as const;
...
export class BulkAcknowledgeAlarmsHandler extends BaseToolHandler {
  ...
  description =
    'Acknowledge multiple security alarms in a single operation. Requires array of alarm IDs. Marks alarms as reviewed but keeps them active.';
  category = 'security' as const;
