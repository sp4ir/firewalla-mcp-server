...
export class BackwardCompatibilityLayer {
  ...
  static toLegacySearchFormat(
    ...
    const legacyFormats: Record<
      string,
      (response: StandardSearchResponse<any>) => any
    > = {
  ...
  static toLegacyPaginatedFormat(
    ...
    const legacyFormats: Record<
      string,
      (response: StandardPaginatedResponse<any>) => any
    > = {
  ...
  static toLegacyStatisticalFormat(
    ...
    const legacyFormats: Record<
      string,
      (response: StandardStatisticalResponse<any>) => any
    > = {
